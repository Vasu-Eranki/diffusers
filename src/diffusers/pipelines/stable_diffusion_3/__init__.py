...
try:
    ...
    _import_structure["pipeline_stable_diffusion_3_masked"] = ["StableDiffusion3Img2ImgPipelineMasked"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_3_masked import StableDiffusion3Img2ImgPipelineMasked
